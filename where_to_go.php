...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
		...
		<div 9id="where_to_go" class="container-fluid profileForm">
			<div class="row profile">
				<div class="col-lg-12 wtg_container">
					<h3 style="font-size: 80px; letter-spacing: 10px;">WHERE TO GO</h3>
					<a href ="wtg_luzon.php"><img src="images/luzon.jpg" class="img-responsive" alt="" />
					EXPLORE LUZON</a>
					 <p>ROADTRIP AROUND LUZON</p>
					 <a href ="wtg_visayas.php"><img src="images/visayas.jpg" class="img-responsive" alt="" />
					EXPLORE VISAYAS</a>
					 <p>WITNESS THE WONDERS OF VISAYAS</p>
					 <a href ="wtg_mindanao.php"><img src="images/mindanao.jpg" class="img-responsive" alt="" />
					EXPLORE MINDANAO</a>
					 <p>EXPERIENCE THE EXTRAVAGANT ACTIVIES OF SOUTH</p>
