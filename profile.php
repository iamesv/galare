...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
			  ...
			  <div class="row">
			   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<a href="#blogs"><h1 class="glyphicon glyphicon-chevron-down"></h1></a>
			...
			try {
				...
				if($row['user_id'] == $_SESSION['userid']){
						...
						echo'<div id="blogs" class=" col-lg-5 blog-contents">';
						echo /*Picture*/ '
						<img src="images/visayas.jpg" class="image-responsive" />';
							...
							echo'<p>'.date('jS M Y', strtotime($row['post_date'])).' | '.$row['username'].'</p>';
